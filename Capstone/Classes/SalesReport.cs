...
//{
//    //SAMPLE SALES REPORTS METHODS FROM TOM USE FOR REFERENCE IF YOU NEED!!!!!!!!!
...
//        public void GenerateReportFile(Dictionary<string, decimal> itemsBought, List<string> itemsPurchased)
//        {
...
//            {
//                grossSales += item.Value * itemsBought[item.Key];
//            }
...
//        private void WriteReportFile(string filePath, decimal sales)
//        {
...
//                }
//                sw.WriteLine();
//                sw.WriteLine("TOTAL SALES: " + sales.ToString("c"));
//            }
//        }
//    }
//}